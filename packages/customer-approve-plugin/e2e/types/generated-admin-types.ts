...
export type Mutation = {
  ...
  switchApproveCustomer: Scalars["Boolean"]["output"];
...
export type MutationSwitchApproveCustomerArgs = {
  customerId: Scalars["ID"]["input"];
};
  ...
  definitions: [
    {
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "switchApproveCustomer" },
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "customerId" },
